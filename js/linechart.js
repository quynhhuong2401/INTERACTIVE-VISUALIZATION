...
d3.csv("https://raw.githubusercontent.com/quynhhuong2401/INTERACTIVE-VISUALIZATION/master/data/datalinechart.csv",
    rowConverter,
    function (error, data) {
        if (error) {
            console.log(error);

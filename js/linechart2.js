...
d3.csv("https://raw.githubusercontent.com/quynhhuong2401/INTERACTIVE-VISUALIZATION/master/data/lan2.csv",
    rowConverter,
    function (error, data) {
        if (error) {
            console.log(error);
...
*/
            ...
            var tooltip = linechart2Selector.append("div")
                .attr('id', 'tooltip')
            ...
            mouseG.append("rect")
                ...
                .on("mouseout", function () {
                    linechart2Selector.select(".mouse-line").style("opacity", "0");
                    linechart2Selector.selectAll(".mouse-per-line circle").style("opacity", "0");
                    linechart2Selector.selectAll(".mouse-per-line text").style("opacity", "0")
                    linechart2Selector.selectAll("#tooltip").style('display', 'none')
                })
                .on("mouseover", function () {
                    linechart2Selector.select(".mouse-line").style("opacity", "1");
                    linechart2Selector.selectAll(".mouse-per-line circle").style("opacity", "1");
                    linechart2Selector.selectAll(".mouse-per-line text").style("opacity", "1")
                    linechart2Selector.selectAll("#tooltip").style('display', 'block')
                })
                .on("mousemove", function () {
                    ...
                    linechart2Selector.selectAll(".mouse-per-line")
                        .attr("transform", function (d) {
                            ...
                            linechart2Selector.select(".mouse-line")
                                .attr("d", function () {
